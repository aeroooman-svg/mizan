...
export const expenseCategories: Category[] = [
  { id: 'food', name: 'Food', nameAr: 'طعام', nameMl: 'ഭക്ഷണം', nameHi: 'भोजन', icon: 'restaurant', iconFamily: 'MaterialIcons', color: '#FF6B6B' },
  { id: 'transport', name: 'Transport', nameAr: 'مواصلات', nameMl: 'യാത്ര', nameHi: 'परिवहन', icon: 'directions-car', iconFamily: 'MaterialIcons', color: '#4ECDC4' },
  { id: 'bills', name: 'Bills', nameAr: 'فواتير', nameMl: 'ബില്ലുകൾ', nameHi: 'बिल', icon: 'receipt-long', iconFamily: 'MaterialIcons', color: '#45B7D1' },
  { id: 'shopping', name: 'Shopping', nameAr: 'تسوق', nameMl: 'ഷോപ്പിംഗ്', nameHi: 'खरीदारी', icon: 'shopping-bag', iconFamily: 'MaterialIcons', color: '#96CEB4' },
  { id: 'health', name: 'Health', nameAr: 'صحة', nameMl: 'ആരോഗ്യം', nameHi: 'स्वास्थ्य', icon: 'medical-services', iconFamily: 'MaterialIcons', color: '#FF8A80' },
  { id: 'education', name: 'Education', nameAr: 'تعليم', nameMl: 'വിദ്യാഭ്യാസം', nameHi: 'शिक्षा', icon: 'school', iconFamily: 'MaterialIcons', color: '#7C4DFF' },
  { id: 'entertainment', name: 'Entertainment', nameAr: 'ترفيه', nameMl: 'വിനോദം', nameHi: 'मनोरंजन', icon: 'movie', iconFamily: 'MaterialIcons', color: '#FF9800' },
  { id: 'rent', name: 'Rent', nameAr: 'إيجار', nameMl: 'വാടക', nameHi: 'किराया', icon: 'home', iconFamily: 'MaterialIcons', color: '#8D6E63' },
  { id: 'phone', name: 'Phone', nameAr: 'هاتف', nameMl: 'ഫോൺ', nameHi: 'फ़ोन', icon: 'phone-android', iconFamily: 'MaterialIcons', color: '#26A69A' },
  { id: 'clothes', name: 'Clothes', nameAr: 'ملابس', nameMl: 'വസ്ത്രങ്ങൾ', nameHi: 'कपड़े', icon: 'checkroom', iconFamily: 'MaterialIcons', color: '#EC407A' },
  { id: 'jameya_savings', name: 'Jameya Savings', nameAr: 'ادخار جمعية', nameMl: 'ചിട്ടി സമ്പാദ്യം', nameHi: 'समिति बचत', icon: 'account-balance', iconFamily: 'MaterialIcons', color: '#0D7C66' },
  { id: 'debt_loan', name: 'Debts & Loans', nameAr: 'ديون وسلف', nameMl: 'കടങ്ങളും വായ്പകളും', nameHi: 'ऋण और उधार', icon: 'swap-horizontal-circle', iconFamily: 'MaterialIcons', color: '#6366F1' },
  { id: 'other_expense', name: 'Other', nameAr: 'أخرى', nameMl: 'മറ്റുള്ളവ', nameHi: 'अन्य', icon: 'more-horiz', iconFamily: 'MaterialIcons', color: '#78909C' },
];

export const incomeCategories: Category[] = [
  { id: 'salary', name: 'Salary', nameAr: 'مرتب', nameMl: 'ശമ്പളം', nameHi: 'वेतन', icon: 'account-balance-wallet', iconFamily: 'MaterialIcons', color: '#0D7C66' },
  { id: 'freelance', name: 'Freelance', nameAr: 'عمل حر', nameMl: 'ഫ്രീലാൻസ്', nameHi: 'फ्रीलांस', icon: 'laptop-mac', iconFamily: 'MaterialIcons', color: '#2196F3' },
  { id: 'investment', name: 'Investment', nameAr: 'استثمار', nameMl: 'നിക്ഷേപം', nameHi: 'निवेश', icon: 'trending-up', iconFamily: 'MaterialIcons', color: '#4CAF50' },
  { id: 'gift', name: 'Gift', nameAr: 'هدية', nameMl: 'സമ്മാനം', nameHi: 'उपहार', icon: 'card-giftcard', iconFamily: 'MaterialIcons', color: '#E91E63' },
  { id: 'bonus', name: 'Bonus', nameAr: 'مكافأة', nameMl: 'ബോണസ്', nameHi: 'बोनस', icon: 'stars', iconFamily: 'MaterialIcons', color: '#FF9800' },
  { id: 'debt_loan', name: 'Debts & Loans', nameAr: 'ديون وسلف', nameMl: 'കടങ്ങളും വായ്പകളും', nameHi: 'ऋण और उधार', icon: 'swap-horizontal-circle', iconFamily: 'MaterialIcons', color: '#6366F1' },
