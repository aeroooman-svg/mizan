...
function generateNotifications(
  ...
  if (balance < 0) {
    notifications.push({
      ...
      body: `رصيد محفظتك الحالية سالب (${formatCurrency(balance, currencySymbol)}). راجع مصاريفك وحاول تعزيز دخلك.`,
      bodyEn: `Your current wallet balance is negative (${formatCurrency(balance, currencySymbol)}). Review your expenses and boost your income.`,
