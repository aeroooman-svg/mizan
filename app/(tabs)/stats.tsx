...
import { getStatsStyles } from '@/components/stats/statsStyles';
import { MonthlyBreakdownModal } from '@/components/stats/MonthlyBreakdownModal';
...
export default function StatsScreen() {
  ...
  const styles = useMemo(() => getStatsStyles(colors), [colors]);
  ...
  return (
    ...
    >
      ...
      <MonthlyBreakdownModal
        visible={detailedBreakdownVisible}
        onClose={() => setDetailedBreakdownVisible(false)}
